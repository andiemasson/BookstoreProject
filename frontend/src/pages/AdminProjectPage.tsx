                ...
                <tbody>
                    {Books.map((p) => (
                        <tr key={p.bookId}>
                            ...
                            <td>{p.price}</td>
                            <td>
                                <button className='btn btn-primary btn-sm w-100 mb-1' onClick={() => setEditingBook(p)}>Edit</button>
                                <button className='btn btn-danger btn-sm w-100 mb-1' onClick={() => handleDelete(p.bookId)}>Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
